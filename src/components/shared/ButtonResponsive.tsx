...
function ButtonResponsive({ id, Svg, label }: ButtonInterface) {
  return (
    <button className="md:min-w-full group flex justify-between items-center gap-2 p-2 focus:outline-indigo-700 border border-gray-500 rounded-md">
